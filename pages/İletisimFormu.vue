<template>
  ...
  <div class="page-container" style="margin-top: 50px; color: #242424;text-align: center">
...
<script>
  export default {
    data: () => ({
      uppitems: ['İnternetten Alışveriş', 'Mağazadan Alışveriş'],
  ...
  "Silivri", "Sultanbeyli", "Sultangazi", "Şile", "Şişli", "Tuzla", "Üsküdar", "Zeytinburnu","Yalova"
],
      orderNumber: '',
      checkbox:false,
      dialog:false,
